function carousel() {
    ...
    const   slides = document.querySelectorAll('.carousel__slide'),
            ...
            carouselWraper = document.querySelector('.carousel__slider-wrapper'),
            width = window.getComputedStyle(carouselWraper).width,
    ...
    carouselWraper.style.overflow = 'hidden';
    ...
    indicators.style.cssText = `
        ...
        list-style: none;
    `; 
    carouselWraper.append(indicators);
